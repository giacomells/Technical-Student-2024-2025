...
- To better understand how the .json files are made,pull the gitlab repository of the SPS from the following link: <https://gitlab.cern.ch/acc-models/acc-models-sps.git>. Once the folder is downloaded, use the file 'BuildSequenceTemplate.py' to build a sequence with specific strengths.
